...
export function SearchPanel() {
  ...
  return (
    <TerrisModalRoot open={searchOpen} onOpenChange={setSearchOpen}>
      <TerrisModalBackdrop className="terris-search-dialog-backdrop" />
      <TerrisModalViewport className="terris-search-dialog-viewport">
        <TerrisModalPanel
          className="terris-search-panel"
          initialFocusRef={inputRef}
          aria-labelledby="terris-search-dialog-title"
        >
          <h2 id="terris-search-dialog-title" className="terris-sr-only">
            Terris search
          </h2>
